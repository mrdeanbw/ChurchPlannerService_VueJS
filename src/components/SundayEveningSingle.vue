      ...
      <div class="half-page">
        ...
        <div class="order">
          <draggable class="dragarea source" @start="drag=true" @end="onEnd">
            <li><img src="static/welcome.svg" alt=""><strong>Welcome &amp; Prayer</strong><a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a></li>
            ...
            <li v-if="item.fields.Missionary_Name" v-for="single_item in item.fields.Missionary_Name"><img src="static/missions.svg" alt=""><strong>Missionary Letter: </strong>{{ single_item }}<a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a></li>
            ...
            <a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a></li>
            
            <li v-if="item.fields.Chorus" v-for="(chrus_item,index) in item.fields.Chorus"><img src="static/chorus.svg" alt=""><strong>Chorus & Fellowship:</strong> {{ item.fields.chorus_name[index] }} <a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a></li>
            <li class="missionary" v-if='item.fields.Special' v-for="(single_item,index) in item.fields.Special">
              <img src="static/special.svg" alt=""><span>{{ item.fields.Special_song_name[index] }} by {{ item.fields.Special_singer[index] }}</span>
              <a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a>
            </li>
            <li v-if="item.fields.Hymns" v-for="(hymn_item,index) in item.fields.Hymns">
              <img src="static/hymnal.svg" alt=""><strong>Hymn: </strong> {{ item.fields.Hymn_Number[index] }}, {{ item.fields.Hymn_Title[index] }} <a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a>
            </li>
            <li class="announcements" v-if="item.fields.Announcements">
              ...
              <ul>
                <li v-for="(announcement_item,index) in item.fields.Announcements">
                  {{ item.fields.announcement_name[index] }}<a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a>
                </li>
              </ul>
            </li>
            <li class="offering" v-if="item.fields.Offering"><img src="static/offeratory.svg" alt=""><strong>Offering</strong>{{ item.fields.Offering_Musician[0] }} - <span v-if="item.fields.Offering_Song">{{ item.fields.Offering_Song[0] }}</span><a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a></li>
            <li class="offering" v-else><img src="static/offeratory.svg" alt=""><strong>Offering</strong><a href="javascript:void(0)" class="close"><img src="static/close.svg" alt="" @click="removeElement($event)"></a></li>
        ...
        <div class="order">
          <div class="dragarea destination">
           <li><img src="static/welcome.svg" alt=""><strong>Welcome &amp; Prayer</strong><a href="#" class="close"><img src="static/close.svg" alt=""></a></li>
            ...
            <li v-if="item.fields.Chorus" v-for="(chrus_item,index) in item.fields.Chorus"><img src="static/chorus.svg" alt=""><strong>Chorus & Fellowship:</strong> {{ item.fields.chorus_name[index] }} <a href="#" class="close"><img src="static/close.svg" alt=""></a></li>
            <li class="missionary" v-if='item.fields.Special' v-for="(single_item,index) in item.fields.Special">
              <img src="static/special.svg" alt=""><span>{{ item.fields.Special_song_name[index] }} by {{ item.fields.Special_singer[index] }}</span>
              <a href="#" class="close"><img src="static/close.svg" alt=""></a>
            </li>
            <li v-if="item.fields.Hymns" v-for="(hymn_item,index) in item.fields.Hymns">
              <img src="static/hymnal.svg" alt=""><strong>Hymn: </strong> {{ item.fields.Hymn_Number[index] }}, {{ item.fields.Hymn_Title[index] }} <a href="#" class="close"><img src="static/close.svg" alt=""></a>
            </li>
            <li class="announcements" v-if="item.fields.Announcements">
              <img src="static/calendar.svg" alt=""><strong>Announcements:</strong>
              <br>
              <ul>
                <li v-for="(announcement_item,index) in item.fields.Announcements">
                  {{ item.fields.announcement_name[index] }}<a href="#" class="close"><img src="static/close.svg" alt=""></a>
                </li>
              </ul>
            </li>
