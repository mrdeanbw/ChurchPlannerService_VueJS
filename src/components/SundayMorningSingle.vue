      ...
      <div class="half-page">
        ...
        <div class="order">
          <ol>
            ...
            <li class="missionary" v-if="item.fields.Special_Position === 'Before Hymns'">{{ item.fields.special_song_name[0] }} by {{ item.fields.Special_singer[0] }}</li>
            </span>
            <li v-if="item.fields.Chorus"><strong>Chorus & Fellowship:</strong> {{ item.fields.Chorus ? item.fields.chorus_name[0] : '-' }}</li>
            ...
            <span v-if='item.fields.Special'>
            <li class="missionary" v-if="item.fields.Special_Position === 'Before Sermon'">{{ item.fields.special_song_name[0] }} by {{ item.fields.Special_singer[0] }}</li>
            </span>
